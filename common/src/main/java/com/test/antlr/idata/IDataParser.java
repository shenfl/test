...
public class IDataParser extends Parser {
	...
	public IDataParser(TokenStream input) {
		super(input);
	...
	public static class FileContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).enterFile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).exitFile(this);
		}
	}
	...
	public static class GroupContext extends ParserRuleContext {
		public Token INT;
		public TerminalNode INT() { return getToken(IDataParser.INT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).enterGroup(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).exitGroup(this);
		}
	}
	...
	public static class SequenceContext extends ParserRuleContext {
		public int n;
		public int i =  1;;
		public List<TerminalNode> INT() { return getTokens(IDataParser.INT); }
		public TerminalNode INT(int i) {
			return getToken(IDataParser.INT, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).enterSequence(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IDataListener ) ((IDataListener)listener).exitSequence(this);
		}
	}
